...
// Extracted from https://github.com/microsoft/PowerToys
...
namespace Jupyscope.Helpers
{
    ...
    /// </summary>
    public class HTMLParsingHelper : IMarkdownExtension
    {
        /// <summary>
        /// Callback if extension blocks external images.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HTMLParsingHelper"/> class.
        /// </summary>
        ...
        public HTMLParsingHelper(ImagesBlockedCallBack imagesBlockedCallBack, string filePath = "")
        {
